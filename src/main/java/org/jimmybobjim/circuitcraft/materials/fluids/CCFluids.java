...
public class CCFluids {
    ...
    static  {
        FluidHelper.create("test", new Color(-1), new Color(-1)).slopeFindDistance(2).levelDecreasePerBlock(1).fluidProperties(FluidType.Properties.create().viscosity(5).density(15)).build(CircuitCraft.REGISTRIES.get());
    }
